            ...
            {section.links.map((link) => {
              const content = (
                <>
                  ...
                  <p className="mt-4 text-xs font-semibold uppercase tracking-normal text-[#0f8f6f]">
              ...
              if (link.href.startsWith("/api/")) {
                return (
                  <a
                    key={link.href}
                    href={link.href}
                    className="rounded-lg border border-slate-200 bg-slate-50 p-5 transition hover:border-emerald-200 hover:bg-emerald-50"
                  >
                    {content}
                  </a>
                );
