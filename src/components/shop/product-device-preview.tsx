...
export function ProductDevicePreview({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-5 right-5 top-1/2 h-1 -translate-y-1/2 rounded-full bg-linear-to-r from-transparent via-secondary-container to-transparent shadow-[0_0_26px_rgba(126,236,201,0.58)]" />
