...
export function PaytrIframePanel({ iframeToken }: PaytrIframePanelProps) {
  return (
    <section className="rounded-[30px] border border-white/80 bg-white/88 p-4 shadow-[0_24px_80px_rgba(6,51,38,0.10)] backdrop-blur-xl sm:p-6 lg:p-8">
      ...
      {iframeToken ? (
        <div className="mt-6 overflow-hidden rounded-[26px] border border-outline-variant/35 bg-white shadow-inner">
          <iframe
        ...
        <div className="mt-6 rounded-[26px] border border-dashed border-primary/35 bg-linear-to-br from-primary/8 via-white to-secondary/8 p-6 text-center sm:p-10">
          <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-primary shadow-[0_14px_30px_rgba(6,51,38,0.12)]">
            <CreditCard className="h-6 w-6" aria-hidden="true" />
          </span>
          <p className="mt-4 text-lg font-black text-on-surface">Ödeme formu beklemede</p>
